...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		IEnumerator Start()
		{
			...
			if ( !playerInstance )
			{
				MSCLoader.ModConsole.Print( "No player instance found in Hand Start()" );
			}
		...
		private void UpdateHovering()
		{
            ...
            MSCLoader.ModConsole.Print("Warning: UpdateHovering, but code is disabled");
		...
		private void HandDebugLog( string msg )
		{
			if ( spewDebugText )
			{
                MSCLoader.ModConsole.Print( "Hand (" + this.name + "): " + msg );
			}
		}
